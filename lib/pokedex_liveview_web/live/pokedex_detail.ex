      ...
      <% else %>
        <div class='flex justify-between my-4'>
          <button phx-click="detail" class="flex items-center group" phx-value-id={Integer.to_string(@prev_pokemon.id)}>
            ...
            <span class="leading-[1px] text-stone-300 group-hover:text-stone-800 transition-all"><%= @prev_pokemon.name %> N.º: <%= @prev_pokemon.id %></span>
          </button>
          <div class="flex">
          ...
          <button phx-click="detail" class="flex items-center group" phx-value-id={Integer.to_string(@next_pokemon.id)}>
            <span class="leading-[1px] text-stone-300 group-hover:text-stone-800 transition-all"><%= @next_pokemon.name %> N.º: <%= @next_pokemon.id %></span>
